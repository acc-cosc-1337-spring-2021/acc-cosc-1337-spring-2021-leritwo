...
int main() 
{
	...
	result_variable=multiply_numbers(num);//use num as the parameter in the function
	...
	result_variable=multiply_numbers(num1);//use num1 as the parameter in the function
